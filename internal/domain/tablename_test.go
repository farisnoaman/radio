...
func TestTableNameUniqueness(t *testing.T) {
	...
	expectedNames := map[string]bool{
		...
		"mst_provider":              true,
		"mst_provider_registration": true,
		"mst_backup_config":         true,
		"mst_backup_record":         true,
		"nas_template":              true,
		"device_config_backup":      true,
		"speed_test_result":         true,
		"radius_proxy_server":       true,
		"radius_proxy_realm":        true,
		"proxy_request_log":         true,
	}
