...
const NodeHeaderCard = () => {
  ...
  const handleCopy = useCallback((text: string, label: string) => {
    ...
    notify(translate('resources.network/nodes.copied', { label, _: '%{label} copied to clipboard' }), { type: 'info' });
  }, [notify, translate]);

  const handleRefresh = useCallback(() => {
    refresh();
    notify(translate('resources.network/nodes.data_refreshed', { _: 'Data refreshed' }), { type: 'info' });
